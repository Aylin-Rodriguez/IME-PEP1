...
# temática y el nivel de dificultad del problema de informaci?n influyen en el tiempo (en segundos) 
...
# valores que pueden considerarse atípicos, por lo tanto se debe ser cauteloso y es por ello que se
# un alfa de 0.01.
...
# mayor que el nivel de significación, por lo que se cumple
# que la matriz de varianza-covarianza es esférica, es decir, entre los diferentes niveles de dificultad
# deben ser iguales.
...
g <- ggqqplot(edad, x = "tiempo", y = "dificultad", color = "dificultad")
